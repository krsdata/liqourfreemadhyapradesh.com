...
<html lang="en">
    ...
    <head>
        ...
        <meta property="og:url" content="http://www.liquorfreemadhyapradesh.com/"/>
		<meta property="og:type" content="website" />
		<meta property="og:title" content="Liquor-free Madhya Pradesh" />
<meta property="og:description" content="आओ हम सब मिल कर बनाए मध्य प्रदेश को एक शराब मुक्त प्रदेश जुड़िये इस अभियान से और इस सफल बनाए, हमारा संकल्प है की हम अने वाले समय में प्रदेश को शराब मुक्त बना के इसे प्रगति और सफलता की और अग्रसर करे l" />
<meta property="og:image" content="http://www.liquorfreemadhyapradesh.com/assets/img/1.jpg" />

    </head>

    <body>
<img src="assets/img/1.jpg" style="display:none">
		<!-- Top menu -->
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            ...
                            <h3 style="color:#FFF;font-size:28px;"><strong>An initiative by Jan Aadhikar Sanghathan Madhya Pradesh</strong></h3>
                            ...
                            <div class="form-bottom contact-form">
			                    ...
			                    <form role="form" action="submit.php" method="post">
			                        ...
			                        <div class="form-group">
			                        	...
			                        	<input type="text" name="phone" placeholder="Your contact number..." class="contact-subject form-control" id="phone" required onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;">
			                        </div>
			                        <div class="form-group">
                                    ...
                                    <div class="form-group">
			                        	<label class="sr-only" for="contact-message">Future Expectations</label>
			                        	<textarea name="future_standing" placeholder="What kind of MP you want to see in next 10 year?" class="contact-message form-control" id="future_standing"></textarea>
			                        </div>
                                    <div class="checkbox">
									...
									<div class="form-group contact_info_box">
			                        	<label for="contact-message">For More Information, Contact : Satish Sharma</label>
                                        <label for="contact-message">Mob : +919111888449 <br>Jan Aadhikar Sanghathan Madhya Pradesh</label>
			                        </div>	
